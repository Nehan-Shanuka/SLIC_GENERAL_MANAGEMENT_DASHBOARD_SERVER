...
{
    public class GENERAL_MONTH_WISE_PL_SUMMARY_Controller : ApiController
    {
        private readonly GENERAL_MONTH_WISE_PL_SUMMARY_Repository _repository;

        public GENERAL_MONTH_WISE_PL_SUMMARY_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_MONTH_WISE_PL_SUMMARY")]
