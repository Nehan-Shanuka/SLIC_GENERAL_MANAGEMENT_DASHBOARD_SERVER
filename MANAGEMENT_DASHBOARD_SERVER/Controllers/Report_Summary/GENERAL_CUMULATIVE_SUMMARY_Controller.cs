...
{
    public class GENERAL_CUMULATIVE_SUMMARY_Controller : ApiController
    {
        private readonly GENERAL_CUMULATIVE_SUMMARY_Repository _repository;

        public GENERAL_CUMULATIVE_SUMMARY_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_CUMULATIVE_SUMMARY")]
        public IHttpActionResult GetGenCumulativeSummary([FromUri] int month)
        {
            try
            {
