...
{
    public class GENERAL_MONTH_PL_SUMMARY_Controller : ApiController
    {
        private readonly GENERAL_MONTH_PL_SUMMARY_Repository _repository;

        public GENERAL_MONTH_PL_SUMMARY_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_MONTH_PL_SUMMARY")]
        public IHttpActionResult GetGenMonthPLSummary([FromUri] int month)
        {
            try
            {
