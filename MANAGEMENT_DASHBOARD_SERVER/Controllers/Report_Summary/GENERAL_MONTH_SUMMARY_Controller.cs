...
{
    public class GENERAL_MONTH_SUMMARY_Controller : ApiController
    {
        private readonly GENERAL_MONTH_SUMMARY_Repository _repository;

        public GENERAL_MONTH_SUMMARY_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_MONTH_SUMMARY")]
        public IHttpActionResult GetGenMonthSummary([FromUri] int month)
        {
            try
            {
