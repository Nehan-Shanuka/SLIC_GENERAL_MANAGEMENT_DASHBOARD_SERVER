...
{
    public class GENERAL_NMOTOR_CMLTV_SUMMARY_N_Controller : ApiController
    {
        private readonly GENERAL_NMOTOR_CMLTV_SUMMARY_N_Repository _repository;

        public GENERAL_NMOTOR_CMLTV_SUMMARY_N_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_NMOTOR_CMLTV_SUMMARY_N")]
        public IHttpActionResult GetNMotorCumulativeSummary([FromUri] int month)
        {
            try
            {
