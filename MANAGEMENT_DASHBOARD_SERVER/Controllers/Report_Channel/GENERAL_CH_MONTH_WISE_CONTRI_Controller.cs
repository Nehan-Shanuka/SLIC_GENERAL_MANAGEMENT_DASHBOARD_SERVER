...
{
    public class GENERAL_CH_MONTH_WISE_CONTRI_Controller : ApiController
    {
        private readonly GENERAL_CH_MONTH_WISE_CONTRI_Repository _repository;

        public GENERAL_CH_MONTH_WISE_CONTRI_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_CH_MONTH_WISE_CONTRI")]
        public IHttpActionResult GetCHMonthWiseContribution([FromUri] int year)
        {
            try
            {
