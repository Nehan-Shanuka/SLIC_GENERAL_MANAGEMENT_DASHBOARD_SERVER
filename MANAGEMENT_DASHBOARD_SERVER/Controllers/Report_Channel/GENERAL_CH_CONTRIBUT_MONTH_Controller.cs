...
{
    public class GENERAL_CH_CONTRIBUT_MONTH_Controller : ApiController
    {
        private readonly GENERAL_CH_CONTRIBUT_MONTH_Repository _repository;

        public GENERAL_CH_CONTRIBUT_MONTH_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_CH_CONTRIBUT_MONTH")]
        public IHttpActionResult GetCHMonthlyContribution([FromUri] int month)
        {
            try
            {
