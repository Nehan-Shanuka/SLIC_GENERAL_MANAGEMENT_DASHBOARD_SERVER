...
{
    public class GENERAL_GENERAL_PERF_CMLTV_Controller : ApiController
    {
        private readonly GENERAL_GENERAL_PERF_CMLTV_Repository _repository;

        public GENERAL_GENERAL_PERF_CMLTV_Controller()
        {
        ...
        [HttpGet]
        [Route("api/Get_GENERAL_GENERAL_PERF_CMLTV")]
        public IHttpActionResult GetGenGenPerfCumulative([FromUri] int month)
        {
            try
            {
